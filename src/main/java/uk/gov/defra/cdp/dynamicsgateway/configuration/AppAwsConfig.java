 ...
 *
 * <p>Bound to the {@code app.aws} prefix in {@code application.yml}. Used to configure the Floci
 ...
 *
 * @param endpointOverride optional AWS endpoint override (e.g. Floci URL)
